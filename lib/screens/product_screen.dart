import 'package:app_fireman/providers/login_form_provider.dart';
import 'package:app_fireman/providers/product_form_provider.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Stack(
              children: [
                EmergencyImage( url: productService.selectedProduct.picture ),
                Positioned(
                  top: 60,
                  left: 20,
                  child: IconButton(
